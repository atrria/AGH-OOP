/* Celem zadania jest przeæwiczenie dziedziczenia wielokrotnego.
  W tym celu stworzymy hierarchiê klas reprezentuj¹cych obiekty
  w grze (6 klas).

  Proszê na podstawie wyniku wywnioskowaæ, jaka jest hierarchia klas
  oraz dopisaæ niezbêdne funkcje.
  W dokumentacji proszê uzasadniæ hierarchniê. Bez tego dokumentacja niewa¿na.
